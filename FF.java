...
public class FF {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=================================================================================================================================\n");
        System.out.println("    /$$$$$$$$/$$$$$$/$$$$$$$$/$$$$$$$$/$$$$$$$$/$$$$$$$$/$$$$$$/$$$$$$$$ /$$$$$$ /$$$$$$/$$$$$$$$/$$   /$$ /$$$$$$ /$$     /$$");
        System.out.println("   | $$_____|_  $$_|__  $$__| $$_____| $$_____| $$_____|_  $$_| $$_____//$$__  $|_  $$_| $$_____| $$$ | $$/$$__  $|  $$   /$$/");
        System.out.println("   | $$       | $$    | $$  | $$     | $$     | $$       | $$ | $$     | $$  \\__/ | $$ | $$     | $$$$| $| $$  \\__/\\  $$ /$$/ ");
        System.out.println("   | $$$$$    | $$    | $$  | $$$$$  | $$$$$  | $$$$$    | $$ | $$$$$  | $$       | $$ | $$$$$  | $$ $$ $| $$       \\  $$$$/  ");
        System.out.println("   | $$__/    | $$    | $$  | $$__/  | $$__/  | $$__/    | $$ | $$__/  | $$       | $$ | $$__/  | $$  $$$| $$        \\  $$/   ");
        System.out.println("   | $$       | $$    | $$  | $$     | $$     | $$       | $$ | $$     | $$    $$ | $$ | $$     | $$\\  $$| $$    $$   | $$    ");
        System.out.println("   | $$      /$$$$$$  | $$  | $$$$$$$| $$     | $$      /$$$$$| $$$$$$$|  $$$$$$//$$$$$| $$$$$$$| $$ \\  $|  $$$$$$/   | $$    ");
        System.out.println("   |__/     |______/  |__/  |________|__/     |__/     |______|________/\\______/|______|________|__/  \\__/\\______/    |__/    ");
        System.out.println("\n");
        System.out.println("                  ____                        __          __                             _____     _        ");
        System.out.println("                 / ____ _____________ ___ ___/ ___ ____  / /____    __ _____ __ ______  / ______ _(____  ___");
        System.out.println("                _\\ \\/ // / __/ __/ -_/ _ / _  / -_/ __/ / __/ _ \\  / // / _ / // / __/ / (_ / _ `/ / _ \\(_-<");
        System.out.println("               /___/\\_,_/_/ /_/  \\__/_//_\\_,_/\\__/_/    \\__/\\___/  \\_, /\\___\\_,_/_/    \\___/\\_,_/_/_//_/___/");
        ...
        System.out.printf("Your BMI as of now is %.1f\n", bmi);
            if(bmi < 18.5){
                ...
                goal = sc.nextInt();
                    while (goal < 1 || goal > 3) {
                        sc.nextLine(); 
                        System.out.println("Error, please choose a number between 1(Get Shredded), 2(Gain Muscle Mass) and 3(Lose Weight): ");
                        while (!sc.hasNextInt()) {
                            sc.nextLine(); 
                            System.out.println("Error, please choose a number between 1(Get Shredded), 2(Gain Muscle Mass) and 3(Lose Weight): ");
                        }
        ...
        System.out.println("==========================================================");
        System.out.println("How much time are you willing to spend working out? \n1. 1-2 Days Per week \n2. 3-5 Days Per Week \n3. 6-7 Days Per week\nInput: ");
            ...
            case 1: //Gym
                ...
                case 1: //1-2 Days
                    ...
                    case 2: 
                        ...
                        {
                        case 1:
                            System.out.println("With Experience Gym Goer (5-8 Months Experience!3-4 Sets - 8-12 Repititions!)\nWorkout A.\n1. Bench Press\n2. Pull Ups or Lat PullDowns\n3. Barbell Squats\n4. Seated Leg Curls\n5. Shoulder Press\n6. Bicep Curls\nWorkout B.\n1. Incline Bench Press\n2. Seated Cable Rows\n3. Hack Squats\n4. Romanian Dead Lifts\n5. Lateral Raise\n6. Tricep Pushdowns\nMeal Plan\nMeal 1. Protein Shake\n Ingreadients\nBanana, 1 Medium Oats, 60Grams Whey Protein, 30g Peanut Butter.\nMeal 2 Lentils\n Ingreadients\n100G Red Lentils, 2 Tomatoes, Chosen Spices (eg. Paprika, Salt, Pepper), 60g Green Beans.\nMeal 3 Chicken\nIngredients\n150g Chicken Breasts, Chosen Spices, 200g White Potato, 30g Broccoli, 30g Carrots\nMeal 4 Eggs\nIngreadients\n3-4 Large Eggs, 200g White Rice, 50g Cabbage, Chosen Spices");
                            break;
                        case 2:
                            System.out.println("With Experience Gym Goer (5-8 Months Experience!3-4 Sets - 8-12 Repititions!)\nWorkout A.\n1. Bench Press\n2. Pull Ups or Lat PullDowns\n3. Barbell Squats\n4. Seated Leg Curls\n5. Shoulder Press\n6. Bicep Curls\nWorkout B.\n1. Incline Bench Press\n2. Seated Cable Rows\n3. Hack Squats\n4. Romanian Dead Lifts\n5. Lateral Raise\n6. Tricep Pulldowns");
                            break;
            ...
            case 2: //Home
                ...
                case 1: //1-2 days
                    ...
                    case 1:
                        ...
                        {
                            case 1:
                            System.out.println("Newbie Home Plan (0-3 Months! Experience 3-4 Sets - 8-12 Repititions!)\nWorkout A\n1. Body Weight Squats\n2. Pull Ups\n3. Mountain Climbers\nWorkout B\n1. Push Ups\n2. Dips\n3. Chin Ups\nMeal Plan\nMeal 1. Protein Shake\n Ingreadients\nBanana, 1 Medium Oats, 60Grams Whey Protein, 30g Peanut Butter.\nMeal 2 Lentils\n Ingreadients\n100G Red Lentils, 2 Tomatoes, Chosen Spices (eg. Paprika, Salt, Pepper), 60g Green Beans.\nMeal 3 Chicken\nIngredients\n150g Chicken Breasts, Chosen Spices, 200g White Potato, 30g Broccoli, 30g Carrots\nMeal 4 Eggs\nIngreadients\n3-4 Large Eggs, 200g White Rice, 50g Cabbage, Chosen Spices");
                            break;
                            case 2:
                            System.out.println("Newbie Home Plan (0-3 Months! Experience 3-4 Sets - 8-12 Repititions!)\nWorkout A\n1. Body Weight Squats\n2. Pull Ups\n3. Mountain Climbers\nWorkout B\n1. Push Ups\n2. Dips\n3. Chin Ups\nNo Meal Plan");
                            break;
                    ...
                    case 2:
                        ...
                        {
                        case 1:
                            System.out.println("With Experience Home Workout (5-8 Months Experience! Whole Day Workouts)\nWorkout A\n1. 150 Normal Squats\n2. 200 Pushups\n3. 100 Crunches\n4. 50 Pullups (Assited Or Negatives)\nWorkout B.\nCardio (Sports, Running, Walking)\nMeal Plan\nMeal 1. Protein Shake\n Ingreadients\nBanana, 1 Medium Oats, 60Grams Whey Protein, 30g Peanut Butter.\nMeal 2 Lentils\n Ingreadients\n100G Red Lentils, 2 Tomatoes, Chosen Spices (eg. Paprika, Salt, Pepper), 60g Green Beans.\nMeal 3 Chicken\nIngredients\n150g Chicken Breasts, Chosen Spices, 200g White Potato, 30g Broccoli, 30g Carrots\nMeal 4 Eggs\nIngreadients\n3-4 Large Eggs, 200g White Rice, 50g Cabbage, Chosen Spices");
                            break;
                        case 2:
                            System.out.println("With Experience Home Workout (5-8 Months Experience! Whole Day Workouts)\nWorkout A\n1. 150 Normal Squats\n2. 200 Pushups\n3. 100 Crunches\n4. 50 Pullups (Assited Or Negatives)\nWorkout B.\nCardio (Sports, Running, Walking)\nNo Meal Plan");
                            break;
